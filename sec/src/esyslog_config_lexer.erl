...
-module(esyslog_config_lexer).

-export([string/1,string/2,token/2,token/3,tokens/2,tokens/3]).
-export([format_error/1]).

%% User code. This is placed here to allow extra attributes.
-file("./esyslog_config_lexer.xrl", 25).
...
-file("./esyslog_config_lexer.erl", 277).
yystate() -> 22.
...
-file("./esyslog_config_lexer.xrl", 9).
yyaction_0(TokenChars, TokenLine) ->
     { token, { host, TokenLine, list_to_atom (tl (TokenChars)) } } .

-compile({inline,yyaction_1/2}).
-file("./esyslog_config_lexer.xrl", 10).
yyaction_1(TokenChars, TokenLine) ->
     { token, { host, TokenLine, list_to_atom (tl (TokenChars)) } } .

-compile({inline,yyaction_2/2}).
-file("./esyslog_config_lexer.xrl", 11).
yyaction_2(TokenChars, TokenLine) ->
     { token, { port, TokenLine, list_to_integer (TokenChars) } } .

-compile({inline,yyaction_3/2}).
-file("./esyslog_config_lexer.xrl", 12).
yyaction_3(TokenChars, TokenLine) ->
     { token, { word, TokenLine, list_to_atom (TokenChars) } } .

-compile({inline,yyaction_4/2}).
-file("./esyslog_config_lexer.xrl", 13).
yyaction_4(TokenChars, TokenLine) ->
     { token, { filepath, TokenLine, list_to_atom (TokenChars) } } .

-compile({inline,yyaction_5/1}).
-file("./esyslog_config_lexer.xrl", 15).
yyaction_5(TokenLine) ->
     { token, { '.', TokenLine } } .

-compile({inline,yyaction_6/1}).
-file("./esyslog_config_lexer.xrl", 16).
yyaction_6(TokenLine) ->
     { token, { ':', TokenLine } } .

-compile({inline,yyaction_7/1}).
-file("./esyslog_config_lexer.xrl", 17).
yyaction_7(TokenLine) ->
     { token, { wildcard, TokenLine } } .

-compile({inline,yyaction_8/1}).
-file("./esyslog_config_lexer.xrl", 18).
yyaction_8(TokenLine) ->
     { token, { newline, TokenLine } } .

-compile({inline,yyaction_9/0}).
-file("./esyslog_config_lexer.xrl", 21).
yyaction_9() ->
     skip_token .
