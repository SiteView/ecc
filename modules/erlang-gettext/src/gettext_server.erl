...
-export([custom_dir/0,get_gettext_dir/1,gettext_dir/0]).
...
<<<<<<< .mine
=======
%% 	io:format("callbackmod0***********~p~n",[CallBackMod0]),
>>>>>>> .r575
    CallBackMod = get_callback_mod(CallBackMod0),
<<<<<<< .mine
=======
%% 	io:format("CallBackMod***********~p~n",[CallBackMod]),
>>>>>>> .r575
    case get_gettext_dir(CallBackMod) of
		no_dir -> 
<<<<<<< .mine
=======
%% 			io:format("CallBackMod22***********~p~n",[CallBackMod]),
>>>>>>> .r575
			{stop, no_gettext_directory};
		GettextDir ->
<<<<<<< .mine
=======
%% 			io:format("CallBackMod44***********~p~n",[CallBackMod]),
>>>>>>> .r575
...
%% gettext_dir() ->
%% 	"F:\S\Server\modules\erlang-gettext\priv".
