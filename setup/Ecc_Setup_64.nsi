...
!define VERSION 9.1
!define FILEVERSION 9.1.2011.1213
...
OutFile "${STR_NAME}_${FILEVERSION}_setup_64.exe"
...
Section -Main SEC0000
	...
	File /r  /x .svn /x src /x doc /x *.java /x *.erl /x *.txt /x *.pdf /x *.dat /x *.log /x *.bak /x *.sql ..\ofbiz
