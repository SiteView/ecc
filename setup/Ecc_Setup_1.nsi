...
!define VERSION 9.1
!define FILEVERSION 9.1.2011.1208
...
OutFile "${STR_NAME}_${FILEVERSION}_setup_1.exe"
...
Section -Main SEC0000
    ...
    File /r  /x .svn /x src /x doc /x *.doc /x *.erl /x *.txt /x 64 /x tables64.bat /x createuser64.bat /x createuser32.bat /x ejabberd-2.1.9-windows-installer.exe /x dotnetfx.exe ..\thirdparty
    ...
    File "/oname=$INSTDIR\tomcat7\webapps\ecc\main\index.zul" index_n.zul
