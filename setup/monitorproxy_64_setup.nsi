...
!define VERSION 9.0
!define FILEVERSION 9.0.2011.1208
...
OutFile "${STR_NAME}_Proxy_${FILEVERSION}_setup_64.exe"
...
Section -Main SEC0000
    ...
    File /r  /x .svn /x src /x doc /x *.doc /x *.erl /x *.txt ..\rest
    ...
    File /r  /x .svn /x src /x doc /x *.doc /x *.erl  ..\templates.topn
    ...
    File /r  /x .svn /x src /x doc /x *.doc /x *.erl /x *.txt /x *.c ..\erl
