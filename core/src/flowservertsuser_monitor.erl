...
%% Created: 2011-10-9
%% Description: TODO: Add description to flowservertsuser
-module(flowservertsuser_monitor,[BASE]).
...
getCounterValues(Host,User,Passwd) ->
		case file:consult("templates.applications/counters.flowservertsuser") of
		{ok,File}->
		    S=File;
		{_,Reason}->
