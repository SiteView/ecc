...
%% Obj = term()
%% @doc  
processTrueDataOld(CollectorList, Data, Count, RequestedStartTime, RequestedEndTime, TimezoneOffset, Precision, ErrorsList, WarningList, GoodList, MaxErrors, MaxWarnings, MaxGoods, ScheduleMap, BestCaseCalc) ->
%% 	[{eof, ChildData1}] = Data,c
	io:format("processTrueData: ~p ~n", ["Start"]),
	MonitorMap = THIS:process_sub_2(CollectorList, dict:new(), RequestedStartTime, RequestedEndTime, Precision, Count),
%% 	io:format("~p ~n", [MonitorMap]),
