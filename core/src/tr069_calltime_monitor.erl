-module(tr069_calltime_monitor,[BASE]).   
...
new() ->
	...
	Base:set_attribute(totalcalltime,0),
	{?MODULE,Base}.
...
update() ->
	...
	receive
		{conf_response,id,{ok, Record}} ->
			...
			case lists:keysearch(totalcalltime,1,R) of
				{value,{totalcalltime,Totalcalltime}} ->
					THIS:set_attribute(totalcalltime,Totalcalltime);
				_ ->
...
get_template_property()->
	...
	[
	#property{name=totalcalltime,title="呼叫总时间",type=scalar,editable=true,order=3}
	].