...
%% Created: 2011-10-8
%% Description: TODO: Add description to flowserver_monitor
-module(flowservervoduser_monitor,[BASE]).
...
getCounterValues(Host,User,Passwd) ->
		case file:consult("templates.applications/counters.flowservervoduser") of
		{ok,File}->
		    S=File;
		{_,Reason}->
