...
-export([text/5, thickline/5, line/4, color/1, color/2]).
...
thickline(Image, P1, P2, Color, ThinColor) ->
    cast(Image, {thickline, P1, P2, Color, ThinColor}),
    ok.
...
loop(Image) ->
	...
	% Drawing primitives
	{egd, _Pid, {thickline, P1, P2, C, TC}} ->
	    loop(egd_primitives:thickline(Image, P1, P2, C, TC));		
