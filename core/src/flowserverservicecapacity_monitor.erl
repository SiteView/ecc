...
%% Created: 2011-10-9
%% Description: TODO: Add description to flowserverservicecapacity
-module(flowserverservicecapacity_monitor,[BASE]).
...
getCounterValues(Host,User,Passwd) ->
		case file:consult("templates.applications/counters.flowserverservicecapacity") of
		{ok,File}->
		    S=File;
		{_,Reason}->
