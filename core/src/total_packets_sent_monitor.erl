-module(total_packets_sent_monitor,[BASE]).
...
update() ->
    ...
    ValueList -> 
        ...
        THIS:set_attribute(?STATE_STRING,"AverageTotalPacketsSent = "++ erlang:integer_to_list(NowV))         
    end.
...
getStateProperties(This,Params) ->
   [
        #property{name=averanger_value,title="Average Total Packets Sent",type=numeric,state=true,configurable=false}
    ].
