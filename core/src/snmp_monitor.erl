...
-define(SNMP_OIDS,[
			...
			{"ifSpecific.ifOperStatus","1.3.6.1.2.1.2.2.1.8"},
			{"ifSpecific.ifSpeed","1.3.6.1.2.1.2.2.1.5"},
			{"ifSpecific.ifInOctets","1.3.6.1.2.1.2.2.1.10"},
			{"ifSpecific.ifInPackets","1.3.6.1.2.1.2.2.1.11"},
			{"ifSpecific.ifInDiscards","1.3.6.1.2.1.2.2.1.13"},
			{"ifSpecific.ifInErrors","1.3.6.1.2.1.2.2.1.14"},
			{"ifSpecific.ifOutOctets","1.3.6.1.2.1.2.2.1.16"},
			{"ifSpecific.ifOutPackets","1.3.6.1.2.1.2.2.1.17"},
			{"ifSpecific.ifOutDiscards","1.3.6.1.2.1.2.2.1.19"},
			{"ifSpecific.ifOutErrors","1.3.6.1.2.1.2.2.1.20"},
			{"cisco.system.freeMem","1.3.6.1.4.1.9.2.1.8"},
			{"cisco.cpu.avgBusy5","1.3.6.1.4.1.9.2.1.58"},
			{"cisco.cpu.avgBusy1","1.3.6.1.4.1.9.2.1.57"},
			{"cisco.system.envTestPt1Measure","1.3.6.1.4.1.9.2.1.79"},
			{"cisco.locIfInBitsSec","1.3.6.1.4.1.9.2.2.1.1.6"},
			{"cisco.locIfInPktsSec","1.3.6.1.4.1.9.2.2.1.1.7"},
			{"cisco.locIfOutBitsSec","1.3.6.1.4.1.9.2.2.1.1.8"},
			{"cisco.locIfOutPktsSec","1.3.6.1.4.1.9.2.2.1.1.9"},
			{"cisco.locIfInOverrun","1.3.6.1.4.1.9.2.2.1.1.14"},
			{"cisco.locIfCollisions","1.3.6.1.4.1.9.2.2.1.1.25"},
			{"cisco.locIfInputQueueDrops","1.3.6.1.4.1.9.2.2.1.1.26"},
			{"cisco.locIfOutputQueueDrops","1.3.6.1.4.1.9.2.2.1.1.27"},
			{"cisco.locIfipInOctets","1.3.6.1.4.1.9.2.2.1.1.44"},
			{"cisco.locIfipOutOctets","1.3.6.1.4.1.9.2.2.1.1.45"}
			]).
...
defaultTitle(Params)->
	...
	case lists:keysearch(proplists:get_value(oid,Params),2,?SNMP_OIDS) of
		{value,{Desc,_}}->
			Desc;
		_->
...
getScalarValues(Prop,Params)->
	case Prop of
		...
		oid->
			?SNMP_OIDS;
		percentageBase->
			[{"no percentage base","no"}] ++ ?SNMP_OIDS;
		scale->
			?SCALES;
		_->
	...
	case proplists:get_value(percentageBase,Params) of
		...
		PercBase ->
			case regexp:match(PercBase,"^[0-9|\.]+$") of
				nomatch->
					[{percentageBase," percentageBase must be a number or an object id"}];
				_->
					[]
			end
	end ++
...
get_template_property()->
	...
	#property{name=oid,title="Object ID",default="1.3.6.1.2.1.1.1",description="the object ID of the main SNMP object to be queried",type=scalar,editable=true,order=2,allowother=true},
