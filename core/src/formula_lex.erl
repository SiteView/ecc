-file("d:/ERL57~1.4/lib/parsetools-2.0.1/include/leexinc.hrl", 0).
...
-file("./formula_lex.xrl", 14).

-file("d:/ERL57~1.4/lib/parsetools-2.0.1/include/leexinc.hrl", 14).
...
yystate(18, [10|Ics], Line, Tlen, _, _) ->
    yystate(18, Ics, Line+1, Tlen+1, 3, Tlen);
...
-file("./formula_lex.xrl", 7).
yyaction_0(TokenChars, TokenLine) ->
     { token, { var, TokenLine, list_to_atom (TokenChars) } } .

-compile({inline,yyaction_1/2}).
-file("./formula_lex.xrl", 8).
yyaction_1(TokenChars, TokenLine) ->
     { token, { atom, TokenLine, list_to_atom (TokenChars) } } .

-compile({inline,yyaction_2/2}).
-file("./formula_lex.xrl", 9).
yyaction_2(TokenChars, TokenLine) ->
     { token, { list_to_atom (TokenChars), TokenLine } } .

-compile({inline,yyaction_3/0}).
-file("./formula_lex.xrl", 10).
yyaction_3() ->
     skip_token .

-file("d:/ERL57~1.4/lib/parsetools-2.0.1/include/leexinc.hrl", 282).
