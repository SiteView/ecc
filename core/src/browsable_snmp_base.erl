...
%%
%%---
-module(browsable_snmp_base,[BASE]).
...
get_template_property()->
	...
	[
	#property{name=server,title="Server", description="the IP address or host name of the server",type=server,editable=true,order=1},
