-module(total_packets_received_monitor,[BASE]).
...
update() ->
    ...
    ValueList -> 
        ...
        THIS:set_attribute(?STATE_STRING,"AverageTotalPacketsReceived = "++ erlang:integer_to_list(NowV))         
    end.
...
getStateProperties(This,Params) ->
   [
        #property{name=averanger_value,title="Average Total Packets Received",type=numeric,state=true,configurable=false}
    ].
