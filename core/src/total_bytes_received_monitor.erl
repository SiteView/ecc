-module(total_bytes_received_monitor,[BASE]).
...
update() ->
    ...
    ValueList -> 
        ...
        THIS:set_attribute(?STATE_STRING,"AverageTotalBytesReceived = "++ erlang:integer_to_list(NowV))         
    end.
...
getStateProperties(This,Params) ->
   [
        #property{name=averanger_value,title="Average Total Bytes Received",type=numeric,state=true,configurable=false}
    ].
