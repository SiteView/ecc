...
public class OracleDBMonitor extends BaseMonitor {
	...
	public int handleMessage() {
		...
		if ("update".equals(this.getMessage().getAction())){
			try {
				resp.put("LCHitRate", DBMonitorFactory.getDBMonitorValue(DBMonitor.DBTYPE_ORACLE,this.getParams(),"LCHitRate"));
