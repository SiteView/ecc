...
import com.dragonflow.siteview.infra.db.util.DB2Query;
...
import com.dragonflow.erlangecc.websphereservlet.*;

public class WebsphereServletMonitor extends BaseMonitor {
	...
	static String metricListURL = ServicePlatform.getRoot()
			+ "/templates.applications/WASServlet.xsl";
	...
	public Map<String, Object> update() {
		...
		if (bOK) {
			...
			for (String s : this.Counters.keySet()) {
				String s1=this.Counters.get(s).toString();
				String value = "";
