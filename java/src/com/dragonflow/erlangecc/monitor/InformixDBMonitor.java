...
public class InformixDBMonitor extends BaseMonitor {
	...
	public int handleMessage() {
		...
		if ("update".equals(this.getMessage().getAction())){
			try {
				resp.put("FreeSharedMemory", DBMonitorFactory.getDBMonitorValue(DBMonitor.DBTYPE_INFORMIX,this.getParams(),"FreeSharedMemory"));
