package com.dragonflow.erlangecc.log;
...
import com.dragonflow.erlangecc.monitor.DatabaseConnectionURL;
...
//	        second insert the data to this table
    ...
    throws java.sql.SQLException
    {
	    ...
	    try {
	    	...
	    	{
    	       System.out.println("jdbc logger error: exec, " + e);
	    	}
	    connection.commit();
        stateString.append(" jdbc logger commit complete, " + i + " records");
	    if(sqlexception != null)
	    {	System.out.println("insert finally error");
