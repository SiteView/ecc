...
public class MapSwitchPhysicalPackages
{
 ...
 // private Session sessionMapPhysicalPackage;
  ...
  public MapSwitchPhysicalPackages( WBEMClient cc1, CIMObjectPath instanceCOP1,   CIM_ComputerSystem ComputerSystem)
  {
  ...
  {
    try {
      CloseableIterator cim_PhysicalPackageEnum = this.cc.associators(this.instanceCOP, "CIM_SystemPackaging", "CIM_PhysicalPackage", "Dependent", "Antecedent", false, false, null);
